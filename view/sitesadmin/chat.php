...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-envelope"></i> Murojatlar</h1>
            <p>Kiruvchi murojatlar</p>
        </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="tile p-0">
                <h4 class="tile-title folder-head">Murojatlar</h4>
                <div class="tile-body">
                    <ul class="nav nav-pills flex-column mail-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-envelope fa-fw"></i> Sent</a></li>
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-file-text fa-fw"></i> Drafts</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-user fa-fw"></i> Trash</a></li>
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-user fa-fw"></i> Trash</a></li>
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-user fa-fw"></i> Trash</a></li>
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-user fa-fw"></i> Trash</a></li>
                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-user fa-fw"></i> Trash</a></li>
        ...
        <div class="col-md-6">
            <div class="tile">
                ...
                <div class="messanger">
                    <div class="messages">
                        <div class="message"><img src="/assets/images/doctor.jpg" width="25px">
                            <p class="info">Hello there!<br>Good Morning</p>
                        </div>
                        <div class="message me"><img src="/assets/images/doctor1.jpg" width="25px">
                            <p class="info">Hi<br>Good kdfldkfldkfldkf kfvdflkdflvk dlkfvdfvlk lkdvlkd  lk dflvkdfl kf lkfd ldk dl kkMorning</p>
                        </div>
                        <div class="message"><img src="/assets/images/doctor.jpg" width="25px">
        ...
        <div class="col-md-3">
            <div class="tile">
                <div class="mailbox-controls">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-primary btn-sm" type="button"><i class="fa fa-trash"></i></button>
