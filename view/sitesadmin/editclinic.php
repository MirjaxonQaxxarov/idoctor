...
<script>
    ...
    submitBtn.addEventListener("click", function submit(e) {
        ...
        $.ajax({
            url: "/locadmin/add/password=<?=str_rot13("Rememberme")?>&token=<?=str_rot13("kvjdfvdfkj@dsd.fd")?><?=4*$keyuser?>/<?=str_rot13('clinic_ru')?>/",
            type: 'POST',
            processData: false,
            contentType: false,
    ...
    CKEDITOR.replace( 'editorru' , {
        filebrowserUploadUrl: '/api/ckedit/<?=str_rot13('image')?>/',
